...
class LaporanSuratKeluar extends MX_Controller {
	private $nama;
	...
	function index(){
		$this->template->display('Laporan/LaporanSuratMasuk/index_surat_keluar');
	}


	function ExportLaporanSuratKeluar()
	{
		$data["tgl_dari"] 				= $this->input->post("tgl_dari");
		$data["tgl_sampai"] 		    = $this->input->post("tgl_sampai");
		$insert = $this->laporan->M_Surat_Keluar($data);
		...
		if($insert['status']=="berhasil"){
			...
			$excel->setActiveSheetIndex(0)->setCellValue('A1', "LAPORAN SURAT KELUAR"); // Set kolom A1 dengan tulisan "DATA Member"
			...
			$excel->setActiveSheetIndex(0)->setCellValue('D3', "TANGGAL SURAT"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
			$excel->setActiveSheetIndex(0)->setCellValue('E3', "PERIHAL"); // Set kolom E3 dengan tulisan "ALAMAT"
			$excel->setActiveSheetIndex(0)->setCellValue('F3', "SIFAT SURAT"); // Set kolom E3 dengan tulisan "ALAMAT"
			$excel->setActiveSheetIndex(0)->setCellValue('G3', "TUJUAN"); // Set kolom E3 dengan tulisan "ALAMAT"
			$excel->setActiveSheetIndex(0)->setCellValue('H3', "ALAMAT"); // Set kolom E3 dengan tulisan "ALAMAT"
			$excel->setActiveSheetIndex(0)->setCellValue('I3', "TEMBUSAN"); // Set kolom E3 dengan tulisan "ALAMAT"
			$excel->setActiveSheetIndex(0)->setCellValue('J3', "KETERANGAN"); // Set kolom E3 dengan tulisan "ALAMAT"
			$excel->setActiveSheetIndex(0)->setCellValue('K3', "NAMA FILE"); // Set kolom E3 dengan tulisan "ALAMAT"
			...
			foreach ($insert['data'] as $data) { // Lakukan looping pada variabel Member
				...
				$excel->setActiveSheetIndex(0)->setCellValue('D' . $numrow, $data['tgl_surat']);
				$excel->setActiveSheetIndex(0)->setCellValue('E' . $numrow, $data['perihal']);
				$excel->setActiveSheetIndex(0)->setCellValue('F' . $numrow, $data['sifat_surat']);
				...
				$excel->setActiveSheetIndex(0)->setCellValue('K' . $numrow, $file);
		...
		redirect('Laporan/LaporanSuratKeluar');
